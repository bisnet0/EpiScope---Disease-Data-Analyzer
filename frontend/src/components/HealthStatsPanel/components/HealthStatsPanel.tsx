    ...
    >
      ...
      >
        <VStack align="start" spacing={0}>
          <Heading
            ...
            alignItems="center"
          >
            <Icon as={FaRunning} mr={3} color="cyan.400" />Central de Saúde
          </Heading>
          <Text fontSize="md" color={theme.mutedText}>
            Sincronização com {activities.length} atividades processadas
          </Text>
        </VStack>
      ...
      <SimpleGrid columns={{ base: 1, lg: 3 }} spacing={6} mb={8}>
        ...
        >
          ...
          {lastActivity && (
            <Stat>
              <StatLabel color={theme.textColor} fontSize="lg" noOfLines={1}>
                {lastActivity.name}
              </StatLabel>
          ...
          {lastActivity?.avg_hr ? (
            ...
            <VStack align="start" spacing={1}>
              ...
              <Text fontSize="xs" color={theme.mutedText}>
                Os treinos recentes não possuem dados de BPM para análise de
                intensidade.
              </Text>
            </VStack>
          )}

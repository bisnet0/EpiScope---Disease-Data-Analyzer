...
# 👇 AJUSTE ARQUITETURAL: Subindo 3 níveis para achar a raiz do backend!
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))       # .../ml-workflow
ARBO_MODULE_DIR = os.path.dirname(SCRIPT_DIR)                 # .../arbovirus
MODULES_DIR = os.path.dirname(ARBO_MODULE_DIR)                # .../modules
BACKEND_ROOT = os.path.dirname(MODULES_DIR)                   # .../backend
